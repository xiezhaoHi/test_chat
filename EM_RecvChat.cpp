...
BEGIN_MESSAGE_MAP(EM_RecvChat, CDialog)
	...
	ON_WM_SHOWWINDOW()
	//}}AFX_MSG_MAP
	ON_STN_CLICKED(IDC_STATIC8, &EM_RecvChat::OnStnClickedStatic8)
	ON_BN_CLICKED(IDC_CANCEL, &EM_RecvChat::OnBnClickedCancel)
END_MESSAGE_MAP()
...
void EM_RecvChat::OnStnClickedStatic8()
{
	// TODO: 在此添加控件通知处理程序代码
}


void EM_RecvChat::OnBnClickedCancel()
{
	// TODO: 在此添加控件通知处理程序代码
}
